      ...
      <DialogContent className="max-w-4xl rounded-2xl">
        <DialogHeader>
          ...
          <p className="pt-1 text-xs text-muted-foreground">
            {step === 0
              ? "Step 1 of 3 · Select a table"
              : step === 1
              ? `Step 2 of 3 · Add items to ${selectedTableName}`
              : `Step 3 of 3 · Customer Details & Place Order`}
          </p>
        </DialogHeader>
            ...
            {step === 0 && (
              <motion.div key="s0" initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
                <p className="mb-3 text-sm text-muted-foreground">
                  Tap a table to continue. Select items and attach customer details next.
                </p>
                {allTables.length === 0 ? (
              ...
              >
                ...
                <div className="rounded-xl border p-3 flex flex-col justify-between">
                  <div>
                    ...
                    {cart.length === 0 ? (
                      <p className="text-xs text-muted-foreground">Tap items on the left to add.</p>
                    ) : (
                  ...
                  <div className="mt-3 border-t pt-2 space-y-2">
                    ...
                    <Button
                      ...
                      onClick={() => setStep(2)}
                    >
                      Continue to Details <ArrowLeft className="ml-1.5 h-4 w-4 rotate-180" />
                    </Button>
                  </div>
                </div>
              </motion.div>
            ...
            {step === 2 && (
              ...
              >
                <div className="rounded-xl border p-4 bg-muted/20">
                  ...
                  <Tabs value={custMode} onValueChange={(v: any) => setCustMode(v)}>
                    ...
                    <TabsContent value="existing" className="space-y-3">
                      <div>
                        <Label className="text-xs">Search Phone Number</Label>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <div>
                          ...
                          <Input
                            type="date"
                            value={newAnni}
                            onChange={(e) => setNewAnni(e.target.value)}
                          />
                        </div>
                      </div>
                    </TabsContent>
                    ...
                    <TabsContent value="guest" className="py-3 text-center text-xs text-muted-foreground">
                      Order will be created without attaching a customer profile.
                    </TabsContent>
                  </Tabs>
                </div>
                ...
                <div className="flex gap-2">
                  <Button variant="ghost" size="sm" onClick={() => setStep(1)}>
                    <ArrowLeft className="mr-1.5 h-3.5 w-3.5" /> Back to Cart
                  </Button>
                  <Button
